...
const ProjectCard = ({ title, description, className, imgSrc }: ProjectCardProps): JSX.Element => {
    return (
        <>
            <a href={`/project/${imgSrc}`} className="flex">
...
const BlogPostList = ({ blogItems }: BlogListProps): JSX.Element => {
    ...
    const listCSS: string = "border-t-2 border-black"
        ...
        <>
            <div className="flex flex-col flex-wrap md:flex-nowrap lg:flex-nowrap">
                <div className="flex flex-wrap md:flex-nowrap lg:flex-nowrap w-full">
                    <div className="m-5 w-full md:w-[70%] lg:w-[70%] p-2 md:p-8 lg:p-8 border border-solid border-black rounded-3xl shadow-custom drop-shadow-lg shadow-black z-100 bg-[#f5fffa]">
                    ...
                    <div className="m-5 w-full md:w-[30%] lg:w-[30%] border border-solid border-black rounded-3xl shadow-custom drop-shadow-lg shadow-black z-100 bg-[#f5fffa]">
                        <img src="/me.jpeg" alt="NFT mint QR code" className="w-full h-full rounded-3xl" />
                    </div>



                    {/* <div className="m-5 w-full md:w-2/5 lg:w-2/5 p-2 border border-solid border-black rounded-md shadow-custom drop-shadow-lg shadow-black z-100 bg-[#f5fffa]">
                ...
                <div className="flex flex-wrap">
                    <div className="flex flex-wrap md:flex-nowrap lg:flex-nowrap w-full md:w-[70%] lg:w-[70%]">
                        <div className="m-5 w-full p-2 md:p-8 lg:p-8 border border-solid border-black rounded-3xl shadow-custom drop-shadow-lg shadow-black z-100 bg-[#f5fffa]">
                            <div className="flex flex-wrap flex-col items-center md:flex-row">
                                ...
                                <div className="flex flex-wrap flex-row">
                                    <div className="flex p-2 w-1/2">
                                        <ProjectCard title="App one" description="App one description" imgSrc="/qr_code.png" className="bg-purple-500 max-h-[500px]"></ProjectCard>
                                    </div>
                                    <div className="flex p-2 w-1/2">
                                        <ProjectCard title="App two" description="App two description" imgSrc="/qr_code.png" className="bg-red-500"></ProjectCard>
                                    </div>
                                    <div className="flex p-2 w-1/2">
                                        <ProjectCard title="App two" description="App two description" imgSrc="/qr_code.png" className="bg-red-500"></ProjectCard>
                                    </div>
                    ...
                    <div className="flex flex-wrap md:flex-nowrap lg:flex-nowrap w-full md:w-[30%] lg:w-[30%]">
                        <div className="flex flex-col">
                            <div className="flex m-5  p-3 md:p-8 lg:p-8 border border-solid border-black rounded-3xl shadow-custom drop-shadow-lg shadow-black z-100 bg-[#f5fffa]">
                                <div className="container mx-auto flex flex-wrap flex-col items-center md:flex-row">
                                    <div className="flex flex-col w-full justify-center items-start text-center md:text-left">
                            ...
                            <div className="flex flex-1 flex-wrap md:flex-nowrap lg:flex-nowrap w-full">
                                <div className="m-5 w-full p-3 md:p-8 lg:p-8 border border-solid border-black rounded-3xl shadow-custom drop-shadow-lg shadow-black z-100 bg-[#f5fffa]">
